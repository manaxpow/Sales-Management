...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white shadow-sm transition-all duration-300">
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="flex items-center justify-between py-2">
              <div className="hidden lg:flex flex-1 items-center">
                ...
                />
                <ContactItem
                  href="abcxyz@gmail.com"
                  label="abcxyz@gmail.com"
                  Icon={IconEnvelope}
                />
                <ContactItem
                  href="/"
                  label="000 Lũy Bán Bích, Phường Tân Phú, TP. HCM"
                  Icon={IconMap}
                />
              </div>
      ...
      <div
        className={`container mx-auto px-4 max-w-7xl transition-all duration-300 ${
          isScrolled ? "py-[2px]" : "py-4"
        }`}
      >
